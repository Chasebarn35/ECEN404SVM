...
void SystemClock_Config(void)
{
  ...
  *///160HZ TODO FIX THE OTER CLOCKS SPEEDS
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_Pin|Start_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LAA1_Pin|LAA2_Pin|LBB1_Pin|LBB2_Pin
                          |LCC1_Pin|LCC2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LAA1_Pin LAA2_Pin LBB1_Pin LBB2_Pin
                           LCC1_Pin LCC2_Pin */
  GPIO_InitStruct.Pin = LAA1_Pin|LAA2_Pin|LBB1_Pin|LBB2_Pin
                          |LCC1_Pin|LCC2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : V_C_Pin V_B_Pin V_A_Pin */
  GPIO_InitStruct.Pin = V_C_Pin|V_B_Pin|V_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
